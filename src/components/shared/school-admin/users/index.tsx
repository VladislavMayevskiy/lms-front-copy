...
import { SchoolAdminUsersColumns } from "./constants/usersTable";
...
import SchoolAdminUserModal from "./components/modals";
...
function SchoolAdminUsers ({ filter }: Props) {
  ...
  const table = useReactTable({
    data: users,
    columns: SchoolAdminUsersColumns,
