...
function CourseProviderUnits({ courseId, moduleId }: { courseId: number; moduleId: number; }) {
  ...
  return (
    <CourseProviderLayout>
      <PageHeader
        ...
        breadcrumb={
          <Breadcrumb separator={<div className="w-2.5 h-2.5 rounded-full bg-dark" />}>
            <BreadcrumbItem>
              <BreadcrumbLink href={CourseProviderRoutes.courses}>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink href={CourseProviderRoutes.modules.replace(":id", courseId.toString())}>
      ...
      <CreateUnitModal
        moduleId={moduleId}
        baseRoute={CourseProviderRoutes.sections.replace(":id", courseId.toString()).replace(":moduleId", moduleId.toString())}
      />
      <DeleteUnit />
      <TranslationsModal />
    </CourseProviderLayout>
